  ...
  Array(153).concat([
    ...
    function(e, t) {
      e.exports = {
        ...
        socialMedia: [
          { name: 'Github', url: 'https://github.com/borenho/' },
          { name: 'Linkedin', url: 'https://www.linkedin.com/in/rutocollins/' },
          { name: 'Stackoverflow', url: 'https://stackoverflow.com/users/6488361/ruto-collins' },
          { name: 'Instagram', url: 'https://www.instagram.com/kaka_ruto_/' },
          { name: 'Twitter', url: 'https://twitter.com/kaka_ruto' },
        ],
        navLinks: [
    ...
    function(e, t, n) {
      ...
      const H = Object(g.c)(m.c).withConfig({
        ...
        G.medium,
        N.SFMono,
        m.f.desktop(O(), G.small),
        G.small,
        m.f.desktop(Y(), G.smallish),
      );
      ...
      Gt.propTypes = { metadata: l.a.object.isRequired };
      const _t = m.h.colors;
          ...
          r.a.createElement(Gn.b, {
            ...
            render: function(e) {
              ...
              return r.a.createElement(
                'div',
                { id: 'root' },
                r.a.createElement(Nt, { metadata: n.siteMetadata }),
      ...
      const Ga = g.c.a.withConfig({ displayName: 'nav__ResumeLink', componentId: 'sc-14stwwa-11' })(
    ...
    function(e) {
      e.exports = {
        data: {
          site: {
            siteMetadata: {
              title: 'Kaka Ruto | Software Engineer',
              siteUrl: 'https://collinsruto.com',
              description:
                'Collins Ruto is a software engineer based in Nairobi, Kenya who specializes in the design and implementation of scalable, highly available APIs in Ruby, Go and GraphQL.',
            },
...
//# sourceMappingURL=0-60b8367a7a78d53b6833.js.map
